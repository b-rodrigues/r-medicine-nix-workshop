...
- Native Code/Positron on Windows: `scripts/nix_expressions/native_vscode_example/`
- Nix and `{targets}`: `scripts/nix_expressions/nix_targets_pipeline`
- Nix and Docker: `scripts/nix_expressions/docker/`
- Nix and `{shiny}`: `scripts/nix_expressions/shiny`
- GitHub Actions: [see
...
- Drop into a temporary shell: `nix-shell --expr "$(curl -sl
