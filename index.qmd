...
<table style="width: 100%;">
  <tr>
    <td style="width: 472px; vertical-align: top;">
      <img src="img/grand_duke.jpg" alt="HRH Grand Duke Henri" style="width: 100%; max-width: 472px;">
    </td>
...
- Nix, the complete end-to-end build tool
- How `{rix}` and `{rixpress}` can help you
